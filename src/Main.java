...
void main() {
    ...
    int intoperandA = 1543;
    int intoperandB = 2545;
    ...
    double myLunchCost = 0.0;
    int kidsInFamily = 1;
    boolean isRaining = false;
    double gasCost = 3.5;
    double favNum = 3.0;
    double shoeSize = 10.0;
    String fullName = "Scott Rowekamp";

    System.out.println("My lunch cost: " + myLunchCost);
    System.out.println("There are " + kidsInFamily + " kid(s) in my family");
    System.out.println("Is it raining? Answer: " + isRaining);
    System.out.println("The gas cost is: " + gasCost);
